...
# это домашнее задание. Вася очень плохо знаком с данной темой, поэтому он нашел словарь, в котором указано,
...
for word in s:
    b = word.lower()
    if (b in a and word not in a[b] or len([j for j in word if j.isupper()]) != 1):
        e += 1
print(e)